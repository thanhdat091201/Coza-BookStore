        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Hãy liên hệ thanhdat09121@gmail.com nếu bạn có bất kỳ thắc mắc nào!!!
                    822 Sư Vạn Hạnh, P10, Quận 10, TP HCM
                    (+086)123456789
                </p>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <form>
                    <div class="wrap-input1 w-full p-b-4">
                        <input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="admin@localhost.com">
